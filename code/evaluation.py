...
from dython.nominal import associations as compute_associations
...
def stat_sim(real_path,fake_path,cat_cols=None):
  ...
  real_corr = compute_associations(real, nominal_columns=cat_cols, plot=False)['corr']

  fake_corr = compute_associations(fake, nominal_columns=cat_cols, plot=False)['corr']
